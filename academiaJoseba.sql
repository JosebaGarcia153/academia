...
CREATE TABLE `cursos` (
  ...
  CONSTRAINT `cursos_necesita_profesores_FK` FOREIGN KEY (`id_profesor`) REFERENCES `usuarios` (`id`)
...
CREATE TABLE `usuarios` (
  ...
  `rol` int(11) NOT NULL COMMENT '1 Usuario\n2 Profesor',
...
-- Dump completed on 2020-09-18  7:08:17

...
/**
 * Servlet Filter implementation class FiltroProfesor
 */
@WebFilter(dispatcherTypes = {
				...
				DispatcherType.ERROR
					...
					, urlPatterns = { "/privado/profesores/*" })
public class FiltroProfesor implements Filter {
	
	private static final Logger LOG = Logger.getLogger(FiltroProfesor.class);
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		} else if (usuarioLogin.getRol() != Usuario.ROL_PROFESOR) {
			
			LOG.warn("Usuario sin privilegios de PROFESOR, SIN AUTORIZACION");
